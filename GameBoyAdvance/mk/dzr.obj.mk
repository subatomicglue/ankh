...
#
# $Id: dzr.obj.mk 805 2004-08-05 13:17:39Z kevin $
# -----------------------------------------------------------------------------
...
C_COMPILE_LINE=		$(C_COMPILE) $(C_COMPILE_FLAGS) $(OBJ_NAME_FLAG) $(OBJ_BUILD_FLAG) $<
CXX_COMPILE_LINE=	$(CXX_COMPILE) $(C_COMPILE_FLAGS) $(OBJ_NAME_FLAG) $(OBJ_BUILD_FLAG) $<

#MAKE_THE_OBJDIR=	@if [ ! -d $(OBJDIR) ]; then mkdir $(OBJDIR) ; fi
MAKE_THE_OBJDIR=	$(shell perl $(shell which mkpath.pl) $(shell perl $(shell which justPath.pl) $@) )
