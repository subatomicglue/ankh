...
# -----------------------------------------------------------------------------
# $Id: dzr.dep.mk 805 2004-08-05 13:17:39Z kevin $
#
...
# generalized.
DEP_GEN_FLAG=	-MM # -M default   -MM don't include system headers
...
MAKE_THE_DEPDIR_SINGLE=	-@if [ ! -d $(DEPDIR) ]; then mkdir $(DEPDIR) ; fi
MAKE_THE_DEPDIR=	$(shell perl $(shell which mkpath.pl) $(shell perl $(shell which justPath.pl) $@) )
